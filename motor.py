...
#the variable "delayOn" stores the time (in seconds) of the motor to remain ON
delayOn = 3

#the variable "delayOff" stores the time (in sec) of the motor to remain OFF
delayOff = 1.5
...
try:
    while True:
        ...
        #this instruction is used to set the maximum speed of the motor
        pwmPIN.ChangeDutyCycle(100)
        #these instruction are used to turn on the motor in the opposite direction
        GPIO.output(DIRA, GPIO.LOW)
